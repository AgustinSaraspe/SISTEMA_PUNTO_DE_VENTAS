...
namespace SISTEMA_DE_VENTAS
{
    public partial class FrmReporteCaja : Form
    {
        ...
        {    
            List<Caja> lista = new CN_Reporte().Caja(dtpFechaInicio.Value.Date.ToString(), dtpFechaFin.Value.ToString());

            dgvData.Rows.Clear();

            foreach (Caja rc in lista)
            {
        ...
        private void btnDescargar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                save.FileName = string.Format("ReporteCaja_{0}.xlsx", DateTime.Now.ToString("ddMMyyyyHHmmss"));
